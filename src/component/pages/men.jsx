...
const Men = () => {
 ...
 const [searchResults, setSearchResults] = React.useState([]);
    useEffect(() => {
      ...
      useEffect(() => {
        const results = menData.filter(person =>
    ...
    return (
        ...
        <nav id="navHeader">
                ...
                <div>
                <SearchIcon />
                <input type="search" onChange={(e) => setSearchTerm(e.target.value)} id="seacher_all" placeholder="SEAECH"/>
                </div>
                </div>
                <div className="col-6">
        ...
        <div className="col-6"style={{textAlign:'center',display:"inline-block",borderLeft:"1px solid #c8c8c8 "}}>
            ...
            <div className="row col-12" id="header_name">
                <div className="col-12" style={{textAlign:"center",fontFamily:`'Dosis', sans-serif`,fontWeight:"bold",fontSize:"23px"}}><p>MEN</p></div>
            </div>
            <div className="row col-12"id="div_show_page_name">
                <div className="col-12">
                    <p style={{fontFamily:`'Dosis', sans-serif`}}>HOME ‣</p> <p id="smalii"style={{fontFamily:`'Dosis', sans-serif`,fontWeight:"bold"}}>MEN</p>
                    </div>
            </div>
